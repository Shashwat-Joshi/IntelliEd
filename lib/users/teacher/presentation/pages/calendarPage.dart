...
class _TeacherCalendarPageState extends State<TeacherCalendarPage> {
  ...
  Future getCalendarData() async {
    print(userData['teacher']['assignedSection'].toString());
    calendarDataForTeacher.clear();
    result.clear();
    try {
      var response = await http.post(
        '$apiUrl/calender/getTeacher',
        body: jsonEncode({
                      ...
                      : Container(
                          child: Column(
                            children: [
                              ...
                              !result["success"] ||
                                      calendarDataForTeacher[isSelectedWeek - 1]
                                              .length ==
                                          0
                                  ? Container(
