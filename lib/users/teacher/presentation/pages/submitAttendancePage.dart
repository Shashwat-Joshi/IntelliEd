...
class _SubmitAttendancePageState extends State<SubmitAttendancePage> {
  ...
  Future getClassData() async {
    ...
    try {
      ...
      classStrength = studentNames.length;
      result = List(studentNames.length);
                              ...
                              InkWell(
                                ...
                                onTap: () {
                                  setState(() {
                                    ...
                                    if (selectAll) {
                                      result.fillRange(
                                          0, studentNames.length, 1);
                                    } else {
                                      result.fillRange(
                                          0, studentNames.length, 0);
                                    }
                                  });
                                },
                                child: Container(
  ...
  Future postAttendanceData() async {
    setState(() {
      isLoading = true;
    });
    ...
    for (int i = 0; i < result.length; i++) {
      finalResult.add({
        "admissonNumber":
            studentData['response'][i]['admissionNumber'].toString(),
        "present": result[i] == 0 ? false : true
      });
    }
    print(finalResult);
    Navigator.push(
