...
class TakeQuizForBehaviourPage extends StatefulWidget {
  ...
  TakeQuizForBehaviourPage({@required this.studentData});
  @override
  ...
  Future submitQuiz() async {
    try {
      var response = await http.post(
        '$apiUrl/quizTaken/updateFromTeacher',
        body: jsonEncode(<String, Object>{
          "admissionNumber": widget.studentData["admissionNumber"],
          "behaviourQuiz": true,
        }),
          ...
          triggerFunction: () {
            Navigator.pushAndRemoveUntil(
              ...
              PageRouteBuilder(
                ...
                pageBuilder: (context, _, __) => AboutStudentsSkillPage(),
              ),
              (route) => false,
            );
          },
